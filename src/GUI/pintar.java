...
public class pintar extends javax.swing.JFrame {
    ...
    public void grafi(){
    ImageIcon logo= new ImageIcon(getClass().getResource("/imagen/loop.PNG"));
       //ImageIcon icono= new ImageIcon(logo.getImage().getScaledInstance(gra.getWidth(), gra.getHeight(), 0));
                label.setIcon(logo);            
    }
